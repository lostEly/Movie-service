CREATE TRIGGER date_deleted_userr_trigger
    ...
    VALUES (old.id, old.date_created, old.date_updated, old.date_of_birthday, old.email, old.last_name, old.name,
            old.sex, old.telephone);
...
CREATE TRIGGER date_deleted_movie_trigger
    ...
    VALUES (old.id, old.date_created, old.date_updated, old.description, old.duration, old.name, old.rating,
            old.release_date);
